...
var dialogo = [
	...
	"Puedes moverte y saltar utilizando la flechas izquierda, derecha y hacia arriba, respectivamente. Además de que puedes interactuar con ciertos objetos de la zona utilizando la flecha hacia abajo.",
	"También cuentas con un arma especial, diseñada para derrotar a las criatura mutantes conocidas como 'Grubs', Puedes utilizarla con la tecla de espacio.",
	"Si bien tu arma es poderosa, esta consume energía. Así que no te confíes y procura optimizar bien este recurso.",
	"Por último, posees un dispositivo llamado 'Purificador', el cual es indispensable para cumplir con tu objetivo. Puedes activarlo utilizando la tecla 'C'.",
